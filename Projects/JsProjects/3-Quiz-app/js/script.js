...
const loadQuestion = () => {
  ...
  // for direct call by id
  // a.nextElementSibling.innerText = data.A;
  // b.nextElementSibling.innerText = data.B;
  // c.nextElementSibling.innerText = data.C;
  // d.nextElementSibling.innerText = data.D;

  // call for by querySelectorAll through makin a const variable
